...
<meta property='og:title' content='{$site_name} - {$uid}'>
 
<meta name="twitter:card" content="photo">
<meta name='twitter:title' content='{$site_name} - {$uid}'>
<meta name='twitter:image' content='{if $brazzify}http://brazzify.me/?s={/if}{$image}'>

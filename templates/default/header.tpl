...
<link rel='stylesheet' type='text/css' href='{$web_root}css/main.css?20120705a' />
...
<div id='search'>
 {if $user.username}
  <img src='http://www.gravatar.com/avatar/{$user.email_hash}?s=16&d=retro&r=pg'> {$user.username} | <a href='' id='logout'>Logout</a>
 {else}

...
<div class="container">
    ...
    <form id="fileupload" action="/upload-handler/index.php" method="POST" enctype="multipart/form-data">
...
<script src="{$web_root}js/ext/tmpl.min.js"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="{$web_root}js/ext/load-image.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="{$web_root}js/ext/canvas-to-blob.min.js"></script>
